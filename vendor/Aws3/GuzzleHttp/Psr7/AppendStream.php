 ...
 */
class AppendStream implements \BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \BaghelSoft\S3Uploads\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
