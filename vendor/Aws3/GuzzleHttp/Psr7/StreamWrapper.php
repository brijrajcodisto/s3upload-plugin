...
class StreamWrapper
{
     ...
     */
    public static function getResource(\BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface $stream)
    {
