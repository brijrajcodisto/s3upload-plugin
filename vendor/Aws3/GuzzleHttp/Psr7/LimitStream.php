 ...
 */
class LimitStream implements \BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
