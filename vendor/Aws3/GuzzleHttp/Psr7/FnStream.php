 ...
 */
class FnStream implements \BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
