...
class QuerySerializer
{
    ...
    public function __construct(\BaghelSoft\S3Uploads\Aws\Api\Service $api, $endpoint, callable $paramBuilder = null)
    {
        $this->api = $api;
        $this->endpoint = $endpoint;
        $this->paramBuilder = $paramBuilder ?: new \BaghelSoft\S3Uploads\Aws\Api\Serializer\QueryParamBuilder();
    }
    /**
    ...
    public function __invoke(\BaghelSoft\S3Uploads\Aws\CommandInterface $command)
    {
        ...
        return new \BaghelSoft\S3Uploads\GuzzleHttp\Psr7\Request('POST', $this->endpoint, ['Content-Length' => strlen($body), 'Content-Type' => 'application/x-www-form-urlencoded'], $body);
    }
}
