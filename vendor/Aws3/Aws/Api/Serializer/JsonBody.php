...
class JsonBody
{
     ...
     * @return string
     */
    public static function getContentType(\BaghelSoft\S3Uploads\Aws\Api\Service $service)
    {
    ...
    private function format(\BaghelSoft\S3Uploads\Aws\Api\Shape $shape, $value)
    {
        switch ($shape['type']) {
            case 'structure':
                $data = [];
            ...
            case 'timestamp':
                ...
                return \BaghelSoft\S3Uploads\Aws\Api\TimestampShape::format($value, $timestampFormat);
            default:
                return $value;
        }
    }
