...
class ConfigurationProvider extends \BaghelSoft\S3Uploads\Aws\AbstractConfigurationProvider implements \BaghelSoft\S3Uploads\Aws\ConfigurationProviderInterface
{
    ...
    protected static $interfaceClass = \BaghelSoft\S3Uploads\Aws\S3\UseArnRegion\ConfigurationInterface::class;
    protected static $exceptionClass = \BaghelSoft\S3Uploads\Aws\S3\UseArnRegion\Exception\ConfigurationException::class;
    /**
    ...
    public static function env()
    {
        return function () {
            ...
            if (!empty($useArnRegion)) {
                return \BaghelSoft\S3Uploads\GuzzleHttp\Promise\promise_for(new \BaghelSoft\S3Uploads\Aws\S3\UseArnRegion\Configuration($useArnRegion));
            }
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            $data = \BaghelSoft\S3Uploads\Aws\parse_ini_file($filename, true, INI_SCANNER_NORMAL);
            if ($data === false) {
            ...
            return \BaghelSoft\S3Uploads\GuzzleHttp\Promise\promise_for(new \BaghelSoft\S3Uploads\Aws\S3\UseArnRegion\Configuration($data[$profile][self::INI_USE_ARN_REGION]));
        };
    }
    /**
    ...
    {
        return function () {
            return \BaghelSoft\S3Uploads\GuzzleHttp\Promise\promise_for(new \BaghelSoft\S3Uploads\Aws\S3\UseArnRegion\Configuration(self::DEFAULT_USE_ARN_REGION));
        };
    }
}
