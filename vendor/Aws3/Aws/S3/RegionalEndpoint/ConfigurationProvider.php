...
use BaghelSoft\S3Uploads\Aws\S3\RegionalEndpoint\Exception\ConfigurationException;
...
class ConfigurationProvider extends \BaghelSoft\S3Uploads\Aws\AbstractConfigurationProvider implements \BaghelSoft\S3Uploads\Aws\ConfigurationProviderInterface
{
    ...
    protected static $interfaceClass = \BaghelSoft\S3Uploads\Aws\S3\RegionalEndpoint\ConfigurationInterface::class;
    protected static $exceptionClass = \BaghelSoft\S3Uploads\Aws\S3\RegionalEndpoint\Exception\ConfigurationException::class;
    /**
    ...
    public static function env()
    {
        return function () {
            ...
            if (!empty($endpointsType)) {
                return \BaghelSoft\S3Uploads\GuzzleHttp\Promise\promise_for(new \BaghelSoft\S3Uploads\Aws\S3\RegionalEndpoint\Configuration($endpointsType));
            }
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            return \BaghelSoft\S3Uploads\GuzzleHttp\Promise\promise_for(new \BaghelSoft\S3Uploads\Aws\S3\RegionalEndpoint\Configuration($data[$profile][self::INI_ENDPOINTS_TYPE]));
        };
    }
    /**
    ...
    {
        return function () {
            return \BaghelSoft\S3Uploads\GuzzleHttp\Promise\promise_for(new \BaghelSoft\S3Uploads\Aws\S3\RegionalEndpoint\Configuration(self::DEFAULT_ENDPOINTS_TYPE));
        };
    }
    /**
    ...
    public static function unwrap($config)
    {
        ...
        if (is_string($config)) {
            return new \BaghelSoft\S3Uploads\Aws\S3\RegionalEndpoint\Configuration($config);
        }
        if (is_array($config) && isset($config['endpoints_type'])) {
            return new \BaghelSoft\S3Uploads\Aws\S3\RegionalEndpoint\Configuration($config['endpoints_type']);
        }
