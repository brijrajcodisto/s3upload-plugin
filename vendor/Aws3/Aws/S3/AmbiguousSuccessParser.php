 ...
 * @internal
 */
class AmbiguousSuccessParser extends \BaghelSoft\S3Uploads\Aws\Api\Parser\AbstractParser
{
    ...
    public function __construct(callable $parser, callable $errorParser, $exceptionClass = \BaghelSoft\S3Uploads\Aws\Exception\AwsException::class)
    {
        $this->parser = $parser;
