 ...
 */
class InstructionFileMetadataStrategy implements \BaghelSoft\S3Uploads\Aws\Crypto\MetadataStrategyInterface
{
     ...
     *                            object keys.
     */
    public function __construct(\BaghelSoft\S3Uploads\Aws\S3\S3Client $client, $suffix = null)
    {  
     error_log('inside meta stra ====>>>>>>>>>>');
     ...
     */
    public function save(\BaghelSoft\S3Uploads\Aws\Crypto\MetadataEnvelope $envelope, array $args)
    {
    ...
    public function load(array $args)
    {
        ...
        $constantValues = \BaghelSoft\S3Uploads\Aws\Crypto\MetadataEnvelope::getConstantValues();
