...
use BaghelSoft\S3Uploads\Aws\Crypto\DecryptionTrait;
use BaghelSoft\S3Uploads\Aws\HashingStream;
use BaghelSoft\S3Uploads\Aws\PhpHash;
use BaghelSoft\S3Uploads\Aws\Crypto\AbstractCryptoClient;
use BaghelSoft\S3Uploads\Aws\Crypto\EncryptionTrait;
 ...
 * @deprecated
 */
class S3EncryptionClient extends \BaghelSoft\S3Uploads\Aws\Crypto\AbstractCryptoClient
{
    ...
    public function putObjectAsync(array $args)
    {
        ...
        return \BaghelSoft\S3Uploads\GuzzleHttp\Promise\promise_for($this->encrypt(\BaghelSoft\S3Uploads\GuzzleHttp\Psr7\stream_for($args['Body']), $args['@CipherOptions'] ?: [], $provider, $envelope))->then(function ($encryptedBodyStream) use($args) {
