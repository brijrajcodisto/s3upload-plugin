 ...
 * @deprecated
 */
class S3EncryptionMultipartUploader extends \BaghelSoft\S3Uploads\Aws\S3\MultipartUploader
{
    ...
    private function getEncryptingDataPreparer()
    {
        return function () {
            ...
            list($this->source, $params) = \BaghelSoft\S3Uploads\GuzzleHttp\Promise\promise_for($this->encrypt($this->source, $this->config['@cipheroptions'] ?: [], $this->provider, $envelope))->then(function ($bodyStream) use($envelope) {
