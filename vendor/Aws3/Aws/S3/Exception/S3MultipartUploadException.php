...
namespace BaghelSoft\S3Uploads\Aws\S3\Exception;
...
class S3MultipartUploadException extends \BaghelSoft\S3Uploads\Aws\Exception\MultipartUploadException
{
     ...
     */
    public function __construct(\BaghelSoft\S3Uploads\Aws\Multipart\UploadState $state, $prev = null)
    {
     ...
     */
    private function collectPathInfo(\BaghelSoft\S3Uploads\Aws\CommandInterface $cmd)
    {
