...
class PostObject
{
     ...
     *                                      behalf.
     */
    public function __construct(\BaghelSoft\S3Uploads\Aws\S3\S3ClientInterface $client, $bucket, array $formInputs, $jsonPolicy)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    ...
    protected function getPolicyAndSignature(\BaghelSoft\S3Uploads\Aws\Credentials\CredentialsInterface $creds)
    {
