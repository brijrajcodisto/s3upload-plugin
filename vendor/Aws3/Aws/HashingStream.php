 ...
 */
class HashingStream implements \BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface $stream, \BaghelSoft\S3Uploads\Aws\HashInterface $hash, callable $onComplete = null)
    {
        $this->stream = $stream;
        $this->hash = $hash;
