 ...
 * @internal
 */
class ApiCallMonitoringMiddleware extends \BaghelSoft\S3Uploads\Aws\ClientSideMonitoring\AbstractMonitoringMiddleware
{
    /**
    ...
    private static function getResultAttemptCount(\BaghelSoft\S3Uploads\Aws\ResultInterface $result)
    {
