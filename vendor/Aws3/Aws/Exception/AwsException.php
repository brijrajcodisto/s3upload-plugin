...
use BaghelSoft\S3Uploads\JmesPath\Env as JmesPath;
 ...
 */
class AwsException extends \RuntimeException implements \BaghelSoft\S3Uploads\Aws\MonitoringEventsInterface, \BaghelSoft\S3Uploads\Aws\ResponseContainerInterface, \ArrayAccess
{
    use HasDataTrait;
     ...
     */
    public function __construct($message, \BaghelSoft\S3Uploads\Aws\CommandInterface $command, array $context = [], \Exception $previous = null)
    {
    ...
    {
        return \BaghelSoft\S3Uploads\JmesPath\Env::search($expression, $this->toArray());
    }
}
