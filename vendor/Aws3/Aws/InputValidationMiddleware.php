...
class InputValidationMiddleware
{
     ...
     * @return callable     */
    public static function wrap(\BaghelSoft\S3Uploads\Aws\Api\Service $service, $mandatoryAttributeList)
    {
    ...
    public function __construct(callable $nextHandler, \BaghelSoft\S3Uploads\Aws\Api\Service $service, $mandatoryAttributeList)
    {
        $this->service = $service;
        $this->nextHandler = $nextHandler;
        $this->mandatoryAttributeList = $mandatoryAttributeList;
    }
    public function __invoke(\BaghelSoft\S3Uploads\Aws\CommandInterface $cmd)
    {
