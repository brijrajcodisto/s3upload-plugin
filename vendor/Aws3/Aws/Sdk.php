...
class Sdk
{
    ...
    public function createClient($name, array $args = [])
    {
        ...
        $client = "BaghelSoft\\S3Uploads\\Aws\\{$namespace}\\{$namespace}Client";
    ...
    public function createMultiRegionClient($name, array $args = [])
    {
        ...
        $service = manifest($name);
        $namespace = $service['namespace'];
        $klass = "BaghelSoft\\S3Uploads\\Aws\\{$namespace}\\{$namespace}MultiRegionClient";
        $klass = class_exists($klass) ? $klass : 'BaghelSoft\\S3Uploads\\Aws\\MultiRegionClient';
