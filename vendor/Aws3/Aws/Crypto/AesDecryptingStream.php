 ...
 */
class AesDecryptingStream implements \BaghelSoft\S3Uploads\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\BaghelSoft\S3Uploads\Psr\Http\Message\StreamInterface $cipherText, $key, \BaghelSoft\S3Uploads\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
