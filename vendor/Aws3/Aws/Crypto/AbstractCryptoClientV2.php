...
abstract class AbstractCryptoClientV2
{
    ...
    public static $supportedKeyWraps = [\BaghelSoft\S3Uploads\Aws\Crypto\KmsMaterialsProviderV2::WRAP_ALGORITHM_NAME];
     ...
     * @internal
     */
    public abstract function encrypt(\BaghelSoft\S3Uploads\GuzzleHttp\Psr7\Stream $plaintext, array $options, \BaghelSoft\S3Uploads\Aws\Crypto\MaterialsProviderV2 $provider, \BaghelSoft\S3Uploads\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \BaghelSoft\S3Uploads\Aws\Crypto\MaterialsProviderInterfaceV2 $provider, \BaghelSoft\S3Uploads\Aws\Crypto\MetadataEnvelope $envelope, array $options = []);
}
