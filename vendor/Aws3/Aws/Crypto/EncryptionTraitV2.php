...
trait EncryptionTraitV2
{
    ...
    private static $encryptClasses = ['gcm' => \BaghelSoft\S3Uploads\Aws\Crypto\AesGcmEncryptingStream::class];
    /**
     ...
     * @internal
     */
    public function encrypt(\BaghelSoft\S3Uploads\GuzzleHttp\Psr7\Stream $plaintext, array $options, \BaghelSoft\S3Uploads\Aws\Crypto\MaterialsProviderV2 $provider, \BaghelSoft\S3Uploads\Aws\Crypto\MetadataEnvelope $envelope)
    {
        ...
        if (!\BaghelSoft\S3Uploads\Aws\Crypto\MaterialsProviderV2::isSupportedKeySize($cipherOptions['KeySize'])) {
        ...
        $envelope[\BaghelSoft\S3Uploads\Aws\Crypto\MetadataEnvelope::CONTENT_KEY_V2_HEADER] = $keys['Ciphertext'];
        unset($keys);
