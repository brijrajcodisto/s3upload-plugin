...
use BaghelSoft\S3Uploads\Aws\Crypto\Cipher\CipherMethod;
use BaghelSoft\S3Uploads\Aws\Crypto\Cipher\Cbc;
...
abstract class AbstractCryptoClient
{
    ...
    public static $supportedKeyWraps = [\BaghelSoft\S3Uploads\Aws\Crypto\KmsMaterialsProvider::WRAP_ALGORITHM_NAME];
    /**
     ...
     * @internal
     */
    public abstract function encrypt(\BaghelSoft\S3Uploads\GuzzleHttp\Psr7\Stream $plaintext, array $cipherOptions, \BaghelSoft\S3Uploads\Aws\Crypto\MaterialsProvider $provider, \BaghelSoft\S3Uploads\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \BaghelSoft\S3Uploads\Aws\Crypto\MaterialsProviderInterface $provider, \BaghelSoft\S3Uploads\Aws\Crypto\MetadataEnvelope $envelope, array $cipherOptions = []);
}
