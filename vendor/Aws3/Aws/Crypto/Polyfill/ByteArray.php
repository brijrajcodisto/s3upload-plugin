...
class ByteArray extends \SplFixedArray
{
    ...
    {
        return new \BaghelSoft\S3Uploads\Aws\Crypto\Polyfill\ByteArray(\pack('N', $num));
    }
    /**
     * @param ByteArray $other
     * @return bool
     */
    public function equals(\BaghelSoft\S3Uploads\Aws\Crypto\Polyfill\ByteArray $other)
    {
     ...
     * @return ByteArray
     */
    public function exclusiveOr(\BaghelSoft\S3Uploads\Aws\Crypto\Polyfill\ByteArray $array)
    {
     ...
     * @return ByteArray
     */
    public static function select($select, \BaghelSoft\S3Uploads\Aws\Crypto\Polyfill\ByteArray $left, \BaghelSoft\S3Uploads\Aws\Crypto\Polyfill\ByteArray $right)
    {
     ...
     * @return self
     */
    public function set(\BaghelSoft\S3Uploads\Aws\Crypto\Polyfill\ByteArray $input, $offset = 0, $length = null)
    {
    ...
    {
        return new \BaghelSoft\S3Uploads\Aws\Crypto\Polyfill\ByteArray(\array_slice($this->toArray(), $start, $length));
    }
    /**
