...
class AstRuntime
{
    ...
    public function __construct(\BaghelSoft\S3Uploads\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \BaghelSoft\S3Uploads\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \BaghelSoft\S3Uploads\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \BaghelSoft\S3Uploads\JmesPath\Parser();
    }
    /**
