...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \BaghelSoft\S3Uploads\JmesPath\Lexer();
        $this->parser = new \BaghelSoft\S3Uploads\JmesPath\Parser($this->lexer);
    }
    ...
    {
        $lexer = new \BaghelSoft\S3Uploads\JmesPath\Lexer();
    ...
    {
        $parser = new \BaghelSoft\S3Uploads\JmesPath\Parser();
