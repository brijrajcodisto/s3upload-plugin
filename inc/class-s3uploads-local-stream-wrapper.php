 ...
 */
class S3Uploads_Local_Stream_Wrapper {
	/**
	...
	static function getDirectoryPath() {
		$upload_dir = S3Uploads::get_instance()->get_original_upload_dir();
	...
	public function stream_flush() {
		...
		$params = [
			'Bucket' => S3Uploads::get_instance()->bucket,
			'Key'    => trim( str_replace( S3Uploads::get_instance()->bucket, '', $this->getTarget() ), '/' ),
		];
		 ...
		 */
		do_action( 's3uploads_putObject', $params );
