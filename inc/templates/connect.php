<div class="card">
	<div class="card-header">
		<div class="d-flex align-items-center">
			<h5 class="m-0 mr-auto p-0"><?php esc_html_e( 'Local File Overview', 's3uploads' ); ?></h5>
	...
	<div class="card-body cloud p-md-5">
		<div class="row align-items-center justify-content-center mb-5">
			<div class="col-lg col-xs-12">
				<p class="lead mb-0"><?php esc_html_e( "Total Bytes / Files", 's3uploads' ); ?></p>
		...
		<div class="row justify-content-center mb-3">
			<div class="col text-center">
				<h4><?php esc_html_e( 'Ready to Connect!', 's3uploads' ); ?></h4>
				<p class="lead"><?php esc_html_e( 'Get smart plan recommendations, create or connect to existing account, and sync to the cloud.', 's3uploads' ); ?></p>
			</div>
		</div>
		<div class="row justify-content-center mb-5">
			<div class="col text-center">
				<form method="post"
					...
					<button class="btn text-nowrap btn-primary btn-lg" type="submit"><span class="dashicons dashicons-cloud"></span> <?php esc_html_e( 'Connect', 's3uploads' ); ?></button>
				</form>
			</div>
		</div>
