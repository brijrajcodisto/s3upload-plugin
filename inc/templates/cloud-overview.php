<div class="card">
	<div class="card-header">
		<div class="d-flex align-items-center">
			<h5 class="m-0 mr-auto p-0"><?php esc_html_e( 'Cloud Storage Overview', 's3uploads' ); ?></h5>
	...
	<div class="card-body cloud p-md-5">
		<div class="row align-items-center justify-content-center mb-5">
			<div class="col-lg col-xs-12 mx-sm-0">
				<p class="lead mb-0"><?php esc_html_e( "This Site's Cloud Bytes / Files", 's3uploads' ); ?> <span class="dashicons dashicons-info text-muted" data-toggle="tooltip" title="<?php esc_attr_e( 'Recalculated every 24 hours', 's3uploads' ); ?>"></span></p>
			...
			<div class="col-lg col-xs-12 text-center mt-5 mt-lg-0 iup-pie-wrapper">
				<p class="h5"><?php printf( esc_html__( '%s / %s', 's3uploads' ), $this->size_format_zero( $cloud_total_size, 2 ), esc_html( $api_data->plan->label ) ); ?></p>
				<canvas id="iup-cloud-pie"></canvas>
			</div>
		</div>
		<div class="row justify-content-center mb-1">
			<div class="col text-center">
				<p><?php esc_html_e( 'Visit the s3Uploads site to view, manage, or change your plan.', 's3uploads' ); ?></p>
				<a class="btn text-nowrap btn-info btn-lg" href="<?php echo esc_url( $this->api_url( '/account/' ) ); ?>" role="button"><?php esc_html_e( 'Account Management', 's3uploads' ); ?></a>
			</div>
		</div>
	</div>
</div>
